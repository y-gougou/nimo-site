...
- [2026-08-14 · ChatGPT 解锁记：住宅 IP 链式代理](2026-08-14.md)
...
### 09-10 · Chrome 无法登录 Google 账号排查记

> 一个登录问题拆出四个独立根因（深信服拦截 / Cookie / 扩展 / 数据中心 IP 风控）；把路由细化成「Google/AI 走住宅、其余走便宜节点」，落地到五台设备，并搞懂策略组与「梯子抽风先查节点」。

- [2026-09-10 · Chrome 无法登录 Google 账号排查记](2026-09-10.md)

### 09-14 · Clash Party 规则工程：换机场 + 全量分流

> 旧覆写残留导致新机场导入失败 → 重写 JS 覆写：动态匹配节点、29 个 mrs 规则集分六类、导入前用真实 mihomo 内核校验、合并重叠总开关、美区 Apple 走家宽；用临时内核 + 换出口 IP 的对照实验定位 ping0.cc 被目标站拉黑。同日把同一套分流落地到五台设备（Clash Party×3 / FlClash / Shadowrocket），踩过 FlClash「覆写≠自由 JS」与「proxy-providers 拉取失败」、Shadowrocket「换机场节点名失效」三个跨端坑。

- [2026-09-14 · Clash Party 规则工程：换机场 + 全量分流](2026-09-14.md)
